...
export const metadata: Metadata = {
  ...
  description: "Create an Earnout campaign on devnet: set the price per user who stays, fund it, and add KOLs by X handle.",
};
    ...
    <>
      ...
      <main id="content" className="mx-auto max-w-6xl px-4 py-14 sm:px-6">
        ...
        <p className="mt-5 max-w-2xl text-lg leading-8 text-muted">
          Set what a KOL earns per user who stays, how long users must stay, and the budget. Add KOLs by X handle.
